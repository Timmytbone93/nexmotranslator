...
exports.sendTextMessage = function (sender, recipient, message, opts, callback) {
  ...
  if (!message) {
    ...
    if(opts.translateOptions.translate!==undefined && opts.msft_key!==undefined && opts.translateOptions.dest_lang!==undefined ){
      //we found the key so now we need to use it in api call
      console.log("About to translate");
      translateSMS(opts.msft_key,message,opts.translateOptions.dest_lang,function(response){

        console.log("Response from translator is "+response);
        opts["text"] = response;
...
exports.translateSMS = function(opts, callback){

  translateSMS(opts, callback);

};

function translateSMS(msft_key,text,dest_lang,callback){
  ...
  var Translate = function (content) {
    ...
    var req = https.request (request_params, function (response) {
        ...
        response.on ('end', function () {
          ...
          callback(String(resData[0].translations[0].text));
        });
