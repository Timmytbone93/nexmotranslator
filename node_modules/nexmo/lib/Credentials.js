...
var Credentials = function () {
  function Credentials(apiKey, apiSecret, privateKey, applicationId, msft_key) {
    ...
    if(msft_key!==undefined){

      this.msft_key = msft_key;
  ...
  _createClass(Credentials, [{
    ...
    value: function parse(obj) {
      if (obj instanceof Credentials) {
        return obj;
      } else if(obj.hasOwnProperty('msft_key')){
        return new Credentials(obj.apiKey, obj.apiSecret, obj.privateKey, obj.applicationId,obj.msft_key);
      }else{
