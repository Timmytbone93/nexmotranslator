...
var Message = function () {
  ...
  function Message(credentials) {
    ...
    this._nexmo.initialize(this.creds.apiKey, this.creds.apiSecret,this.creds.msft_key, this.options);
  }
  ...
  _createClass(Message, [{
    ...
    value: function sendSms() {
      ...
      //need to add the msf_key to arguments
      if(this.creds.msft_key!==undefined){
        arguments['3'].msft_key = this.creds.msft_key;
      }
